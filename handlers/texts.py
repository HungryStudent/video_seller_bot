hello = "Здравствуйте, здесь вы можете заказать анимацию логотипа"
...
class TrialVideo:
    enter_url = "Перейдите по ссылке: https://www.renderforest.com/ru/intro-videos (выберите интро и пришлите ссылку на него или название)"
    enter_logo = "Пришлите фото логотипа в высоком качестве в PNG на прозрачном фоне"
